...
const Gdpr = (props) => {
    ...
    return (
        ...
        <Fragment>
            {
                shouldRender ? <div className={styles.Wrapper}>
                    <div className={styles.Content}>
                        ...
                        <div className={styles.Content__Btns}>
                            <button
                                onClick={onBtnClick}
                                className={[styles.Btn__Decline, bothBtnClasses, agreeBtnClasses].join(" ")}>{agreeText}</button>
                            <button
                                onClick={onBtnClick}
                                className={[styles.Btn__Agree, bothBtnClasses, declineBtnClasses].join(" ")}>{declineText}</button>
                        </div>
                    </div>
                </div> : null
            }
