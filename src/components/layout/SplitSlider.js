...
class SplitSlider extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      parentHeight: heightHigher > heightHigher ? heightHigher : heightLower,
    });
  ...
  render() {
    return (
      <Wrapper
        style={{ height: this.state.parentHeight }}
        onMouseMove={this.handleMouseMove}
      >
        <LowerLayer
          ref={(divElementLower) => {
            this.divElementLower = divElementLower;
          }}
        ...
        <TopLayer
          ref={(divElementHigher) => {
            this.divElementHigher = divElementHigher;
          }}
        ...
        <SkewedHandle
          left={this.state.handle}
          background={this.props.handleColor}
...
class TopLayer extends React.Component {
  render() {
    ...
    return (
      <SkewedLayerTop
        width={this.props.layerWidth || 50}
        transform={SkewedDegree(this.props.degree)}
      >
